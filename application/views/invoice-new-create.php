			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
				  <div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Save Invoice</h4>
				  </div>
				  ...
				  <div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" name="btnSaveInvoice" id="btnSaveInvoice">Save</button>
				  </div>
				</div>
			  </div>
			</div>
                    ...
                    <div class="showback">
                      <div class="form-horizontal">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" id="txtInvoiceNo" name="txtInvoiceNo" value="<?php echo $Data_NewInvoice; ?>">
							  </div>
                          </div>
						   <div class="form-group">
